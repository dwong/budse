...
class BudseGUI(QtGui.QMainWindow):
    ...
    def __init__(self, user, parent=None):
        ...
        self.fun = ('Non-Sequiturs Rule The Day', 'GTWW',
                    ...
                    '%s, I am your Budse' % self.user.name,
                    "I'll never let go, %s.  I promise." % self.user.name,
                    ...
                    '%s, I want you to draw me like one of your French girls' %
                    self.user.name, "Southwest Women's Adventure Group",
                    'Let us play the beautiful game',
                    "I'm the Budse of the world!", 'Robert loved Raymond',
                    'Frank smells', '%s FTW' % self.user.name,
...
#        self.refresh()
    ...
    def deselect_all_accounts(self):
	    ...
	    self.ui.snapshot.clear()
            ...
            twi = QtGui.QTableWidgetItem(random.choice(self.fun))
